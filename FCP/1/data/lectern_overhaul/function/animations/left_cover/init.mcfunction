...
execute if score @s lectern_overhaul.animation_timer matches -23..-3 run function lectern_overhaul:animations/left_cover/close/init
execute if score @s lectern_overhaul.animation_timer matches 0..20 run function lectern_overhaul:animations/left_cover/open/init
